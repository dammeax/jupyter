...
RUN echo $(awk 'NR==n-3{sub(/.$/,"")}1' n=$(wc -l /root/.local/share/jupyter/kernels/pythonwithpixiedustspark22/kernel.json)) > /root/.local/share/jupyter/kernels/pythonwithpixiedustspark22/kernel.json
